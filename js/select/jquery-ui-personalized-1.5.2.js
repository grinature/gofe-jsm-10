...
$.widget("ui.draggable", $.extend({}, $.ui.mouse, {
	...
	mouseStart: function(e) {
		...
		this.offset.parent = {	// fix for ie.																		//Store its position plus border
			top: (jQuery.browser.msie) ? 0 : po.top + (parseInt(this.offsetParent.css("borderTopWidth"),10) || 0),
	...
	generatePosition: function(e) {
		...
		//var x = (this.cssPosition == "fixed" || (this.cssPosition == "absolute" && this.offsetParent[0] == document.body) ? 0 : this.offsetParent[0].scrollTop)
		//var s = (this.cssPosition == "fixed" ? $(document).scrollTop() : 0)
		//alert(e.pageY + " - " + this.offset.click.top + " - " + this.offset.relative.top +  " - " + this.offset.parent.top  + " + " +  x + " - " + s)
